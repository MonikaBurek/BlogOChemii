...
<div id="comments" class="comments-area">
	...
	<?php 
        ...
        'title_reply'=>'Zostaw komentarz',
        // remove "Text or HTML to be displayed after the set of comment fields"
        'comment_notes_after' => '',
        // redefine your own textarea (the comment body)
        'comment_field' => ' 
        <div class="form-group"><textarea class="form-control floating-label" placeholder="Komentarz*" rows="5" id="comment" name="comment" aria-required="true"></textarea></div>',

        'fields' => apply_filters( 'comment_form_default_fields', array(

	    'author' =>
	      '<div class="form-group">' .
	      '<input class="form-control floating-label" placeholder="Imie*" id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) .
	    ...
	    'url' =>
	      '<div class="form-group">'.
	      '<input class="form-control floating-label" placeholder="Strona" id="url" name="url" type="text" value="' . esc_attr( $commenter['comment_author_url'] ) .
	      '" size="30" /></div>'
	    )
	  ),
	);
