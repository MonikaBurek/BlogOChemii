...
<section class="no-results not-found">
	<div class="card">
		<div class="entry-container">
			<header>
				<h1 class="page-title"><?php _e( 'Nic nie znaleziono', 'materialwp' ); ?></h1>
			</header><!-- .page-header -->
			...
			<div class="page-content">
				...
				<?php elseif ( is_search() ) : ?>
					...
					<p><?php _e( 'Przepraszamy, ale nic nie pasuje do wyszukiwanych haseł. Spróbuj ponownie, używając kilku innych słów kluczowych.', 'materialwp' ); ?></p>
					<?php get_search_form(); ?>
